...
def getOperationMetadata():
    ...
    memoryUnit = memory1[len(memory1) - 2]
    memorySize = float(memory1[len(memory1) - 2])

    print(type(memoryUnit))
    print(type(memorySize))

    print ( memory1[len(memory1) - 1] ) 
    print ( memory1[len(memory1) - 2] ) 
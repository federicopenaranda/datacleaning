...
def infoDataset(request):
    ...
    print(missing_values_count.values)
    print(missing_values_count.to_json())
    ...
    # json.dumps(missing_values_count)

    # missString = missing_values_count.astype(str)
    # print(missString)
    # print(type(missString))

    miss = {"fede1": "1", "fede2": "2"}

    return jsonify( info=s, description=desc2, missing=miss )